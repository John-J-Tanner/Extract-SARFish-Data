...
# Load CSV
csv_path = '../../Labels/GRD_is_vessel_HIGH_confidence_balanced.csv'
...
# Save to HDF5
with h5py.File(f'./GRD_uncompiled/GRD_isVessel_7600samples_{image_width}x{image_height}patches_HIGHconfidence_balanced_batch{i:03d}.h5', 'w') as h5f:
