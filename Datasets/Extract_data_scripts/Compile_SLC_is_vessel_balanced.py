...
output_file = '../SLC_isVessel_7614samples_16x16patches_HIGHconfidence_balanced.h5'

# Get sorted list of batch files
batch_files = sorted(glob.glob(os.path.join(input_dir, 'SLC_isVessel_7614samples_16x16patches_HIGHconfidence_balanced_batch*.h5')))
