...
# Load CSV
csv_path = '../../Labels/SLC_is_fishing_HIGH_confidence_balanced.csv'
...
# Save to HDF5
with h5py.File(f'./SLC_uncompiled/SLC_isFishing_1852samples_{image_width}x{image_height}patches_HIGHconfidence_balanced_batch{i:03d}.h5', 'w') as h5f:
