...
output_file = '../GRD_isFishing_1864samples_16x16patches_HIGHconfidence_balanced.h5'

# Get sorted list of batch files
batch_files = sorted(glob.glob(os.path.join(input_dir, 'GRD_isFishing_1864samples_16x16patches_HIGHconfidence_balanced_batch*.h5')))
