...
input_dir = './SLC_uncompiled'
output_file = '../SLC_isFishing_1852samples_16x16patches_HIGHconfidence_balanced.h5'

# Get sorted list of batch files
batch_files = sorted(glob.glob(os.path.join(input_dir, 'SLC_isFishing_1852samples_16x16patches_HIGHconfidence_balanced_batch*.h5')))
...
with h5py.File(output_file, 'w') as f_out:
    ...
    f_out.create_dataset('is_fishing', data=labels_all, compression='gzip')
